...
/**
 * This class has interfaces used for document field-values extraction after they are retrieved from an Opensearch
 * instance. This includes field extractors and field writer factories using the field extractor framework.
 */
class OpensearchTypeUtils
{
    private static final Logger logger = LoggerFactory.getLogger(OpensearchTypeUtils.class);
    private final OpensearchFieldResolver fieldResolver;

    protected OpensearchTypeUtils()
    {
        this.fieldResolver = new OpensearchFieldResolver();
    }
