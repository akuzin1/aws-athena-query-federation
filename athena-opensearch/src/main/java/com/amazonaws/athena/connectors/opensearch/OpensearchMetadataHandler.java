 ...
 * in your Opensearch instance. Additionally, this class tells Athena how to split up reads against this source.
        ...
        extends GlueMetadataHandler
{
    ...
    // names and associated endpoints can be auto-discovered via the AWS ES SDK. Or, the Opensearch service
     ...
     * from the Opensearch instance (e.g. "_shards:5" - retrieve shard number 5).
     */
    private static final String SHARD_VALUE = "_shards:";

    private final AWSGlue awsGlue;
    private final AwsRestHighLevelClientFactory clientFactory;
    private final OpensearchDomainMapProvider domainMapProvider;

    private OpensearchGlueTypeMapper glueTypeMapper;
    ...
    public OpensearchMetadataHandler(java.util.Map<String, String> configOptions)
    {
        ...
        this.domainMapProvider = new OpensearchDomainMapProvider(this.autoDiscoverEndpoint);
        ...
        this.glueTypeMapper = new OpensearchGlueTypeMapper();
    ...
    protected OpensearchMetadataHandler(
        ...
        String spillBucket,
        String spillPrefix,
        OpensearchDomainMapProvider domainMapProvider,
    ...
    /**
     * Used to get the list of domains (aka databases) for the Opensearch service.
     ...
     * indices from the Opensearch instance.
     */
    @Override
     ...
     * information for the index from the Opensearch instance.
     */
    @Override
        ...
        if (schema == null) {
            ...
            try {
                ...
                try {
                    ...
                    schema = OpensearchSchemaUtils.parseMapping(mappings);
                }
                catch (IOException error) {
    ...
    /**
     * Opensearch does not support partitioning so this method is a NoOp.
    ...
    {
        // NoOp - Opensearch does not support partitioning.
    }
    ...
    /**
     * Gets an endpoint from the domain mapping. For AWS Opensearch Service, if the domain does not exist in
