...
/**
 * This class is responsible for providing Athena with actual rows level data from your Opensearch instance. Athena
 * will call readWithConstraint(...) on this class for each 'Split' you generated in OpensearchMetadataHandler.
 */
        ...
        extends RecordHandler
{
    ...
    private final OpensearchTypeUtils typeUtils;
    ...
    public OpensearchRecordHandler(java.util.Map<String, String> configOptions)
    {
        ...
        this.typeUtils = new OpensearchTypeUtils();
    ...
    @VisibleForTesting
    protected OpensearchRecordHandler(
        AmazonS3 amazonS3,
            ...
            throws RuntimeException
    {
        ...
        String shard = recordsRequest.getSplit().getProperty(OpensearchMetadataHandler.SHARD_KEY);
        long numRows = 0;
        ...
        if (queryStatusChecker.isQueryRunning()) {
            ...
            try {
                ...
                SearchSourceBuilder searchSource = new SearchSourceBuilder()
                        ...
                        .fetchSource(OpensearchQueryUtils.getProjection(recordsRequest.getSchema()))
                        .query(OpensearchQueryUtils.getQuery(recordsRequest.getConstraints().getSummary()));
