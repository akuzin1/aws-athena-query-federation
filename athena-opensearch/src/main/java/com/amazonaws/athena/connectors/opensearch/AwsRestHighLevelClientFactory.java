...
public class AwsRestHighLevelClientFactory
{
    ...
    /**
     * A flag indicating how the created clients will authenticate to an Opensearch instance.
     ...
     * @param endpoint is the Opensearch instance endpoint.
     * @return an Opensearch REST client.
     */
    ...
    /**
     * Creates a new Opensearch REST client. If useAwsCredentials = true, the client is injected with AWS
     ...
     * returned.
     * @param endpoint is the Opensearch instance endpoint. The latter may contain username/password credentials
     *                 for Opensearch services that are external to Amazon.
     *                 Examples:
