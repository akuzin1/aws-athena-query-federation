...
import com.amazonaws.athena.connectors.opensearch.AwsRestHighLevelClient;
import com.amazonaws.athena.connectors.opensearch.AwsRestHighLevelClientFactory;
import com.amazonaws.athena.connectors.opensearch.OpensearchDomainMapProvider;
...
/**
 * Used to create Opensearch indices and insert documents for use with the Integration Tests.
 */
public class OpensearchIndexUtils implements AutoCloseable
{
    private static final Logger logger = LoggerFactory.getLogger(OpensearchIndexUtils.class);
    ...
    public OpensearchIndexUtils(String domainName, String index) {
        AwsRestHighLevelClientFactory clientFactory = new AwsRestHighLevelClientFactory(true);
        OpensearchDomainMapProvider domainMapProvider = new OpensearchDomainMapProvider(true);
