        ...
        extends TestBase
{
            ...
            throws Exception
    {
        ...
        this.opensearchMetadataHandler = new OpensearchMetadataHandler(databaseConnectionConfig, this.secretsManager, this.athena, this.jdbcConnectionFactory, java.util.Map.of());
            ...
            throws Exception
    {
        ...
        OpensearchMetadataHandler opensearchMetadataHandler = new OpensearchMetadataHandler(databaseConnectionConfig, this.secretsManager, this.athena, jdbcConnectionFactory, java.util.Map.of());
            ...
            throws Exception
    {
        ...
        expectedSplits.add(Collections.singletonMap(OpensearchMetadataHandler.BLOCK_PARTITION_COLUMN_NAME, "p0"));
        expectedSplits.add(Collections.singletonMap(OpensearchMetadataHandler.BLOCK_PARTITION_COLUMN_NAME, "p1"));
