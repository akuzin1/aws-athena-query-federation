...
/**
 * This class is used to test the OpensearchMetadataHandler class.
 */
@RunWith(MockitoJUnitRunner.class)
public class OpensearchMetadataHandlerTest
{
    private static final Logger logger = LoggerFactory.getLogger(OpensearchMetadataHandlerTest.class);

    private OpensearchMetadataHandler handler;
    ...
    @Mock
    private OpensearchDomainMapProvider domainMapProvider;
    ...
    /**
     * Used to test the doListSchemaNames() functionality in the OpensearchMetadataHandler class.
     */
    @Test
    public void doListSchemaNames()
    {
        ...
        ListSchemasResponse mockDomains =
                new ListSchemasResponse("opensearch", ImmutableList.of("domain2", "domain3", "domain1"));
        ...
        handler = new OpensearchMetadataHandler(awsGlue, new LocalKeyFactory(), awsSecretsManager, amazonAthena,
                "spill-bucket", "spill-prefix", domainMapProvider, clientFactory, 10, com.google.common.collect.ImmutableMap.of());

        ListSchemasRequest req = new ListSchemasRequest(fakeIdentity(), "queryId", "opensearch");
    ...
    /**
     * Used to test the doListTables() functionality in the OpensearchMetadataHandler class.
     * @throws IOException
     */
    @Test
            ...
            throws Exception
    {
        ...
        ListTablesRequest req = new ListTablesRequest(fakeIdentity(),
                "queryId", "opensearch", "movies", null, UNLIMITED_PAGE_SIZE_VALUE);
    ...
    /**
     * Used to test the doGetTable() functionality in the OpensearchMetadataHandler class.
     * @throws IOException
     */
    @Test
            ...
            throws Exception
    {
        ...
        handler = new OpensearchMetadataHandler(awsGlue, new LocalKeyFactory(), awsSecretsManager, amazonAthena,
                "spill-bucket", "spill-prefix", domainMapProvider, clientFactory, 10, com.google.common.collect.ImmutableMap.of());
        GetTableRequest req = new GetTableRequest(fakeIdentity(), "queryId", "opensearch",
        ...
        assertTrue("Real and mocked mappings are different!",
                OpensearchSchemaUtils.mappingsEqual(realMapping, mockMapping));

        logger.info("doGetTable - exit");
    }

    /**
     * Used to test the doGetSplits() functionality in the OpensearchMetadataHandler class.
     */
    @Test
            ...
            throws Exception
    {
        ...
        response.getSplits().forEach(split -> {
            ...
            String shard = split.getProperty(OpensearchMetadataHandler.SHARD_KEY);
