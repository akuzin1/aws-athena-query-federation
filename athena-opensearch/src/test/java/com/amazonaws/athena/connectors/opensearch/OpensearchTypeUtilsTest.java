...
/**
 * This class is used to test the OpensearchTypeUtils class.
 */
@RunWith(MockitoJUnitRunner.class)
public class OpensearchTypeUtilsTest
{
    private static final Logger logger = LoggerFactory.getLogger(OpensearchTypeUtilsTest.class);
    private OpensearchTypeUtils typeUtils = new OpensearchTypeUtils();
