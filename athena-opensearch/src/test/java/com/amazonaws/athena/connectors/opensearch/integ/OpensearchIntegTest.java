...
/**
 * Integration-tests for the Opensearch connector using the Integration-test module.
 */
public class OpensearchIntegTest extends IntegrationTestBase
{
    ...
    /**
     * Creates an Opensearch Cluster used for the integration tests.
     */
    @BeforeClass
    @Override
            ...
            throws Exception
    {
        ...
        try {
            // Create the CloudFormation stack for the Opensearch Cluster.
    ...
    /**
     * Deletes a CloudFormation stack for the Opensearch Cluster.
     */
    @AfterClass
    @Override
    protected void cleanUp()
    {
        ...
        super.cleanUp();
        // Delete the CloudFormation stack for the Opensearch Cluster.
        cloudFormationClient.deleteStack();
    }

    /**
     * Gets the CloudFormation stack for the Opensearch Cluster.
     * @return Stack object for the Opensearch Cluster.
     */
    private Stack getOpensearchStack()
    {
        Stack stack = Stack.Builder.create(theApp, dbClusterName).build();

        Domain.Builder.create(stack, "OpensearchCluster")
    ...
    {
        try (OpensearchIndexUtils indexUtils = new OpensearchIndexUtils(domainName, index))
        {
        ...
        try (OpensearchIndexUtils indexUtils = new OpensearchIndexUtils(domainName, TEST_DATATYPES_TABLE_NAME))
        {
...
//                .put("date_type", Date.parse(TEST_DATATYPES_DATE_VALUE))
        ...
        OpensearchIndexUtils emptyIndex = new OpensearchIndexUtils(domainName, TEST_EMPTY_TABLE_NAME);
        emptyIndex.addDocument(new ImmutableMap.Builder<String, Object>().build());
        emptyIndex.close();

        try (OpensearchIndexUtils indexUtils = new OpensearchIndexUtils(domainName, TEST_NULL_TABLE_NAME))
        {
            Map<String, Object> item = new ImmutableMap.Builder<String, Object>()
