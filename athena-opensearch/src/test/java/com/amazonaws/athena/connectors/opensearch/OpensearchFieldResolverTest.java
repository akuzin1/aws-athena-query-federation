...
/**
 * This class is used to test the OpensearchFieldResolver class.
 */
@RunWith(MockitoJUnitRunner.class)
public class OpensearchFieldResolverTest
{
    private static final Logger logger = LoggerFactory.getLogger(OpensearchFieldResolverTest.class);

    private Schema mapping;
    private Map<String, Object> document;
    private Map<String, Object> expectedResults = new HashMap<>();
    private OpensearchFieldResolver resolver = new OpensearchFieldResolver();
