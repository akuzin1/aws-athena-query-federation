...
class OpensearchFieldResolverGenerativeTest extends BlockUtilsPropertiesTest {

    private static final Logger logger = LoggerFactory.getLogger(OpensearchFieldResolverGenerativeTest.class);
    ...
    protected FieldResolver getFieldResolver(Schema schema) {
        return (FieldResolver) (new OpensearchFieldResolver());
    }
