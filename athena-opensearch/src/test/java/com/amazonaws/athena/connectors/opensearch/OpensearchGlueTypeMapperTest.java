...
/**
 * This class is used to test the OpensearchGlueTypeMapper class.
 */
@RunWith(MockitoJUnitRunner.class)
public class OpensearchGlueTypeMapperTest
{
    private static final Logger logger = LoggerFactory.getLogger(OpensearchGlueTypeMapperTest.class);
    ...
    public void getFieldTest()
    {
        ...
        OpensearchGlueTypeMapper glueTypeMapper = new OpensearchGlueTypeMapper();
        Field field;
