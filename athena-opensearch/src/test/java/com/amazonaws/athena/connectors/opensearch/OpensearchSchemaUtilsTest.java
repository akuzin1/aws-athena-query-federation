...
/**
 * This class is used to test the OpensearchSchemaUtils class.
 */
@RunWith(MockitoJUnitRunner.class)
public class OpensearchSchemaUtilsTest
{
    private static final Logger logger = LoggerFactory.getLogger(OpensearchSchemaUtilsTest.class);
    ...
    public void parseMappingTest()
    {
        ...
        Schema builtSchema = OpensearchSchemaUtils.parseMapping(mapping);

        // The built mapping and expected mapping should match.
        assertTrue("Real and mocked mappings are different!",
                OpensearchSchemaUtils.mappingsEqual(expectedSchema, builtSchema));
            ...
            throws JsonProcessingException
    {
        ...
        Schema builtSchema = OpensearchSchemaUtils.parseMapping(actual);
        // The built mapping and expected mapping should match.
        assertTrue("Real and mocked mappings are different!",
                OpensearchSchemaUtils.mappingsEqual(expected, builtSchema));
